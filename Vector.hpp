...
namespace ft {
  ...
  class VectorIterator {
   public:
    ...
    VectorIterator(const self &copy) : ptr_(copy.ptr_) {};
  ...
  class ConstVectorIterator {
   public:
    typedef ConstVectorIterator<T>          self;
    ...
    ConstVectorIterator(value_type *ptr) : ptr_(ptr) {};
    ConstVectorIterator(const VectorIterator<T> &copy) : ptr_(copy.getPtr()) {};
    ConstVectorIterator(const self &copy) : ptr_(copy.ptr_) {};
